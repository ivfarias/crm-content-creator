...
export default function RSSFeedForm() {
  ...
  return (
    <div className="space-y-6">
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="mt-1 flex rounded-md shadow-sm">
            ...
            <button
              type="submit"
              className="inline-flex items-center px-3 py-2 border border-l-0 border-gray-300 rounded-r-md bg-emerald-500 text-white text-sm hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
            >
              Add Feed
            </button>
          </div>
      ...
      <div>
        <h3 className="text-lg font-medium text-slate-900 mb-2">Current RSS Feeds</h3>
        {feeds.length === 0 ? (
